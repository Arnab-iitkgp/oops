...
class CWH{ // abstract base class-- designed for more classes to be inherited from this class.
        // for ex music system of tesla, as it might have differnt model cars so all cars need a music system so from this class they will inherit
        //Abstract base class must have Atleast ONE PURE VIRTUAL FUNCTION
    protected:
        string title;
        float rating;
    public:
